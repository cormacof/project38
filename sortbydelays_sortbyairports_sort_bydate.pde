...
"sort by date", color(0,0,200), stdFont, EVENT_BUTTON2);
widget4=new Widget(100, 10, 180, 40,
"backward", color(2000,200,200), stdFont, EVENT_BACKWARD);
widget5=new Widget(100, 350, 180, 40,
"JAN-MARCH", color(0,0,200), stdFont, EVENT_JAN);
widget6=new Widget(100, 400, 180, 40,
"APRIL-JUNE", color(0,0,200), stdFont, EVENT_APRIL);
size(400, 400);
